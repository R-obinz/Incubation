            ...
            <div className="flex flex-wrap -mx-3 mb-6">
              {/* <div className="w-full px-3">
                ...
                <textarea
                  ...
                  type="text"
                  placeholder=" Describe your team and backgroud"
                  required
                />
              </div> */}
              <div className="w-full px-3">
                ...
                <textarea
                  ...
                  id="grid"
                  type="text"
                  placeholder=" Describe about your company and product"
                  required
                />
              </div>
              <div className="w-full px-3">
              ...
              {/* <div className="w-full px-3">
                ...
                <textarea
                  ...
                  id="grid-password"
                  type="text"
                  placeholder="What is your value proposition htmlFor the customer ?"
                  required
                />
              </div> */}
              <div className="w-full px-3">
